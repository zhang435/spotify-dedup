...
var _oauthConfig = require('./oauth-config');

var _oauthConfig2 = _interopRequireDefault(_oauthConfig);
  ...
  function obtainToken(options) {
    ...
    var promise = new Promise(function (resolve, reject) {
      ...
      function receiveMessage(event) {
        ...
        if (event.origin !== _oauthConfig2.default.host) {
          reject();
          return;
        }
        if (authWindow !== null) {
      ...
      var params = {
        client_id: _oauthConfig2.default.clientId,
        redirect_uri: _oauthConfig2.default.redirectUri,
        response_type: 'token'
      };
      ...
      authWindow = window.open('https://accounts.spotify.com/authorize?' + toQueryString(params), 'Spotify', 'menubar=no,location=no,resizable=no,scrollbars=no,status=no, width=' + width + ', height=' + height + ', top=' + top + ', left=' + left);
...
},{"./oauth-config":25}],37:[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":37}],14:[function(require,module,exports) {
...
var _oauthManager2 = _interopRequireDefault(_oauthManager);
...
function PlaylistModel(playlist) {
  ...
  this.duplicates = _knockout2.default.observableArray([]);
  var self = this;
  this.removeDuplicates = function () {
    ...
    if (self.playlist.collaborative) {
      ...
      promiseThrottle.add(function () {
        ...
        return api.removeTracksFromPlaylist(self.playlist.owner.id, self.playlist.id, chunk).then(function () {
  ...
  this.processed = _knockout2.default.observable(false);
}

function PlaylistsDedupModel() {
  var self = this;
  this.playlists = _knockout2.default.observableArray([]);
  this.isLoggedIn = _knockout2.default.observable(false);
  this.toProcess = _knockout2.default.observable(100);
  this.duplicates = _knockout2.default.computed(function () {
    var total = 0;
    _knockout2.default.utils.arrayForEach(self.playlists(), function (playlist) {
      total += _knockout2.default.utils.unwrapObservable(playlist.duplicates()).length;
    });
    return total;
  });
}

var PlaylistProcessor = function PlaylistProcessor() {};
        ...
        page.items.forEach(function (item, index) {
          if (item.track.id !== null) {
            ...
            if (item.track.id in seenIds) {
              ...
              /*jshint camelcase:false*/
              if (seenNameAndArtistKey in seenNameAndArtist && Math.abs(seenNameAndArtist[seenNameAndArtistKey] - item.track.duration_ms) < 2000) {
                isDuplicate = true;
              }
            }
            if (isDuplicate) {
...
var promiseThrottle = new _promiseThrottle2.default({ requestsPerSecond: 5 }),
...
document.getElementById('login').addEventListener('click', function () {
  _oauthManager2.default.obtainToken({
    scopes: [
    /*
...
function fetchUserOwnedPlaylists(user) {
  return promisesForPages(promiseThrottle.add(function () {
    ...
    pages.forEach(function (page) {
      userOwnedPlaylists = userOwnedPlaylists.concat(page.items.filter(function (playlist) {
...
function onUserDataFetched(data) {
  ...
  fetchUserOwnedPlaylists(user).then(function (ownedPlaylists) {
    ...
    model.playlists().forEach(function (playlist) {
      playlistProcessor.process(playlist).then(onPlaylistProcessed.bind(this, playlist)).catch(onPlaylistProcessed.bind(this, playlist));
    });
  });
}
...
function onTokenReceived(accessToken) {
  ...
  api = new _spotifyWebApiJs2.default();
...
function promisesForPages(promise) {
  ...
  function fetchGeneric(results, offset, limit) {
    return api.getGeneric(stripParameters(results.href) + '?offset=' + offset + '&limit=' + limit);
  }
...
},{"promise-throttle":29,"spotify-web-api-js":30,"knockout":31,"./oauth-manager":26,"../styles/main.css":14,"../styles/custom.css":15}],13:[function(require,module,exports) {
...
//# sourceMappingURL=/main.0f431d7b.map